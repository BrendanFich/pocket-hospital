<template>
  <div class="cardManage">
    <div class="btns">
      <van-button v-if="visitCardBanding === '1'" type="info" class="addBtn" color="linear-gradient(to right, #45bcec, #63d4f2)" @click="linkTo('/mine/cardManage/bindCard')">绑定就诊卡</van-button>
      <van-button v-if="visitCardBanding === '0'" type="info" class="addBtn" color="linear-gradient(to right, #33cab9, #2ce794)" @click="toBandCardHtml">添加健康卡</van-button>
    </div>
